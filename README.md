...
graph TB
    subgraph Vite["Vite Dev Server (port 5173)"]
        direction TB
        Browser["🌐 Browser"] <--> Express["Express API"]
        Browser <--> WS["WebSocket 实时推送"]
